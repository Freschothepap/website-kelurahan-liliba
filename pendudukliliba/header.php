...
<body class="bg-gray-100">
    <!-- Header -->
    <header class="fixed top-0 right-0 left-0 bg-black shadow-md z-10">
        <div class="flex items-center justify-between px-6 py-3">
            <div class="flex items-center">
                <button id="toggleSidebar" class="text-red-500 hover:text-white focus:outline-none mr-4">
                    <i class="fas fa-bars text-xl"></i>
                </button>
                <h1 class="text-xl font-semibold text-red-500">Sistem Informasi Penduduk Kelurahan Liliba</h1>
            </div>
                ...
                <div class="relative">
                    <button id="profileDropdown" class="flex items-center space-x-2 focus:outline-none">
                        <div class="h-8 w-8 rounded-full bg-gray-300 overflow-hidden">
                            <img src="https://st4.depositphotos.com/4035913/20227/v/450/depositphotos_202271402-stock-illustration-grunge-brush-letter-logo-design.jpg" alt="Foto Profil" class="w-full h-full object-cover">
                        </div>
