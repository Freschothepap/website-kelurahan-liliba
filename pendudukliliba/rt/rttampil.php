...
if (isset($_GET['hapus'])) {
    ...
    $stmt->execute();
    header("Location: admin.php?tampil=rttampil&pesan=hapus");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id_rt'])) {
    ...
    if ($nomor_rt && $nama_rt && $alamat_rt && $id_rw) {
        ...
        $stmt->execute();
        header("Location: admin.php?tampil=rttampil&pesan=update");
        exit;
    } else {
...
<div class="mb-4 flex justify-center">
    <a href="admin.php?tampil=rttambah" class="inline-block bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition">
        ...
        <tr class="bg-yellow-100">
            <form method="POST">
                ...
                <td class="px-4 py-2 border text-center">
                    ...
                    <a href="admin.php?tampil=rttampil" class="inline-flex items-center bg-gray-500 text-white px-3 py-1 rounded hover:bg-gray-600 transition ml-2">
